          ...
          <ul class="dropdown-menu">
            ...
            <div class="row" >
                <div class="col-sm1-12 content">
                    ...
                    <div class="col-sm-6" style="height: 300px; margin-top: 110px;">
                        <center><h3>  <marquee width='150px' direction='left' scrollamount='15'>&lt;&lt; &lt;&lt;&lt;&lt;</marquee>
                          ...
                          <fomr>
                              Type Here<textarea class="form-control"></textarea>
                              <br><input type="submit" class="form-control btn-info" value="Add Notification">
                          </fomr>
                       </div>
                    </div>
                    <div class="col-sm-3">
