          ...
          <ul class="dropdown-menu">
            ...
            <div class="row" >
                <div class="col-sm1-12 content">
                    ...
                    <div class="col-sm-6" style="height: 350px; margin-top: 70px;">
                         <center><h3>  <marquee width='150px' direction='left' scrollamount='15'>&lt;&lt; &lt;&lt;&lt;&lt;</marquee>
                          ...
                          <form>
                              Review Forum<input type="text" class="form-control" placeholder="Review">
                              <br>
                              <span class="glyphicon glyphicon-star-empty" style="font-size: 95px;"></span>
                         <span class="glyphicon glyphicon-star-empty" style="font-size: 90px;"></span>
                         <span class="glyphicon glyphicon-star-empty" style="font-size: 87px;"></span>
                         <span class="glyphicon glyphicon-star-empty" style="font-size: 84px;"></span>
                         <span class="glyphicon glyphicon-star-empty" style="font-size: 81px;"></span><br>
                         <br><input type="submit" class="btn-success right" value="Submit Now">
