  ...
  <li role="presentation"><a href="ticketbook.jsp">Ticket Booking</a></li>
                ...
                <div class="col-sm-9" style="height: 500px;">
                     <div class="row" style="height:60px; background-color: beige;text-align: center; font-size: 25px;">
                         ...
                         <marquee  direction='left' width='200px'>&lt;&lt;&lt;&lt;&lt;</marquee>Ticket Booking
                         <marquee direction='right' width='200px'>&gt;&gt;&gt;&gt;&gt;</marquee>
                     </div>
                     <div class="row" style="height:300px; margin-top: 65px; ">
                         <div class="col-sm-3">
                         </div>
                         <div class="col-sm-6" style="border: 1px solid black; border-radius: 8px; height: 300px">
                         <br>
                         From Station:
                         <input type="text" name="fstation" class="form-control" placeholder="From-Station">
                          To Station:
                          ...
                          <br>
                          <input type="submit" class="form-control btn-success" value="Print-Ticket">
                         </div>
                         <div class="col-sm-3">
                         </div>
                     </div>
